        ...
        <Field.Main controller>
          {({ field: { value, onChange } }) => (
            <div className="mt-4 overflow-hidden rounded-xl border">
              ...
              <label className="flex h-14 cursor-pointer items-center justify-center gap-2 border-t bg-white font-semibold text-red-500 transition-colors duration-300 hover:bg-zinc-100">
